<?php
	...
	$query_logged_user_info	=	mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM users WHERE email_address='$logged_user'"));
	...
	$whatsapp_contact						=			$query_logged_user_info['whatsapp_contact'];
